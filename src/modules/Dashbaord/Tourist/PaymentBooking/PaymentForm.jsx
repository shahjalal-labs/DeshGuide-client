        ...
        <div data-aos="fade-left">
          ...
          >
            ...
            <button
              type="submit"
              disabled={!stripe}
              className="btn w-full py-3 rounded-md font-semibold text-lg transition-all duration-300 bg-indigo-600 text-white hover:bg-indigo-500 hover:shadow-indigo-400 shadow-xl hover:scale-105"
              data-aos="zoom-in"
            >
              Pay ${amount}
            </button>

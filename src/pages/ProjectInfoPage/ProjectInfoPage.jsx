  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Developer Section - Updated Image Container */}
        <motion.section
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <div className="relative overflow-hidden rounded-full w-64 h-64 mx-auto border-2 border-indigo-500/50 shadow-[0_0_30px_rgba(99,102,241,0.3)] hover:shadow-[0_0_50px_rgba(165,180,252,0.5)] transition-all duration-500">
                <img
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="flex-1">
              <img
                // src="https://i.ibb.co/Kj9V8674/profile-Rounded.png"
                src="https://i.ibb.co/sdkqSVHm/profile.jpg"
